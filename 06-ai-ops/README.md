...
Pillar 06-ai-ops chịu trách nhiệm AI workforce infrastructure:
...
2. Phase 7 implements skill in `06-ai-ops/skills/<skill-name>/`
...
*Pillar 06-ai-ops scaffolded by Agent OS Boilerplate. Customize per project — different domains may not need all skills/adapters.*
